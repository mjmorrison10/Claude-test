...
Reference full template: `/home/user/Claude-test/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Claude-test/.claude/gsd-core/templates/state.md`.
