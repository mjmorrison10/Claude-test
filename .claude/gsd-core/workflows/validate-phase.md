...
```
Agent(
  prompt="Read /home/user/Claude-test/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Claude-test/.claude/gsd-core/templates/VALIDATION.md`
