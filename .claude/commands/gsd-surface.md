...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Claude-test/.claude/.gsd-surface.json`
(sibling to `/home/user/Claude-test/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Claude-test/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Claude-test/.claude/skills`).
...
`/home/user/Claude-test/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Claude-test/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Claude-test/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Claude-test/.claude/.gsd-profile`
Skill dirs: `/home/user/Claude-test/.claude/skills/gsd-*/`
Engine module: `/home/user/Claude-test/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Claude-test/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
